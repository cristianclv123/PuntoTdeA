...
# Minimal set of Lucide-style stroke icons (24x24, stroke=currentColor) used
# across the Punto TdeA screens. Kept as raw <path>/<circle> inner markup so
# the {% icon %} tag can wrap it in a properly sized <svg>.
ICONS = {
    "inbox": '<path d="M22 12h-6l-2 3h-4l-2-3H2"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/>',
    "book-open": '<path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/>',
    "send": '<path d="M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"/><path d="m21.854 2.147-10.94 10.939"/>',
    "megaphone": '<path d="M2 11v3a1 1 0 0 0 1 1h1.5l1.5 5h2l-1-5h5.42a1 1 0 0 1 .6.2L18 18v-6.5"/><path d="M2 11a1 1 0 0 1 1-1h4.4a5 5 0 0 0 4.6-3v0a5 5 0 0 0 4.6-3H18v14h-1.4a5 5 0 0 0-4.6-3v0a5 5 0 0 0-4.6-3H3a1 1 0 0 1-1-1z"/><path d="M20 8v8"/>',
    ...
    "eye-off": '<path d="M10.733 5.076a10.7 10.7 0 0 1 1.267-.076c5 0 9.27 3.11 11 7.5a11.8 11.8 0 0 1-2.443 3.907"/><path d="M6.15 6.15C4.03 7.51 2.36 9.6 1 12c1.73 4.39 6 7.5 11 7.5a10.9 10.9 0 0 0 5.05-1.15"/><path d="M1 1l22 22"/><path d="M9.363 9.363a3 3 0 0 0 4.243 4.243"/>',
